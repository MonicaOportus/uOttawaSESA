 function Contact() {
     return(
         <div className="contact font-medium text-[18px] mt-[50px] py-[70px] px-[40px] text-white md:pl-[110px] xl:pr-[200px] 
         lg:grid lg:grid-cols-2 lg:gap-24 xl:pl-[210px]">
            <div>
                ...
                <p>
                    ...
                    <span className="font-bold">uottawa.sesa@gmail.com</span> or through any of our social media platforms.
                </p>
            </div>
            <div>
                <h1 className="font-bold text-[48px]">Contact</h1>
                <p className="pb-[15px]">Email us at <a href="mailto:uottawa.sesa@gmail.com" className="hover:underline font-bold">uottawa.sesa@gmail.com</a></p>
                <p>Or find us on:</p>
